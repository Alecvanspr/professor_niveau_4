...
## Niveaukader beheren met alleen tekst
- Plaats of bewerk je niveau-omschrijvingen in `backend/app/config/niveaukader_professor.json`.
- Laad dit niveaukader in de database via:
